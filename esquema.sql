...
CREATE TABLE ATLETA (
    ...
    CONSTRAINT FK_ATL FOREIGN KEY(ATL_SIGLA_TIME, ATL_SIGLA_ESPORTE) REFERENCES TIME(SIGLA_TIME, SIGLA_ESPORTE) ON DELETE CASCADE,
...
CREATE TABLE DISPUTA (
    ...
    CONSTRAINT FK_DISPUTA_TIME FOREIGN KEY (SIGLA_TIME, SIGLA_ESPORTE) REFERENCES TIME(SIGLA_TIME, SIGLA_ESPORTE) ON DELETE CASCADE,
